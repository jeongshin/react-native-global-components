...
import type { AndroidBackBehavior } from '../../types';
import { KeyboardAvoidingLayout, FullScreenOverlay } from '../Layout';
import type { KeyboardAvoidingLayoutProps } from '../Layout/KeyboardAvoidingLayout/KeyboardAvoidingLayout';
...
const InputPopup: React.FC<InputPopupProps> = ({
  ...
  useHideOnAndroidBackPress({ enabled: androidBackBehavior === 'hide' });
